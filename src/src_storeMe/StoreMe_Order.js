  ...
  render() {
    return (
      <View style={{ width: '100%', backgroundColor: '#FFFFFF', height: 50, flexDirection: 'row', }} >
        ...
        <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize1, { marginTop: 10, marginLeft: '30%' }]} >ออเดอร์ของฉัน</Text>
      </View>
    );
  }
}
...
export class Order_Me extends Component {
  ...
  render() {
    return (
      <View >
        <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize2, { margin: 5 }]}>รายการคำสั่งซื้อ</Text>
        <View style={{ backgroundColor: '#FFFFFF', width: '100%', }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10, }}>
            ...
            <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize2, { color: '#0A55A6', marginTop: 10, }]}>ยังไม่ชำระ</Text>
          </View>
    ...
    return (
      <View>
        <View style={{ width: '100%', backgroundColor: '#FFFFFF', flexDirection: 'row', justifyContent: 'space-between', padding: 10, marginTop: 5, }}>
          <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize2]}> รวมการสั่งซื้อ (1 สินค้า): </Text>
          <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize2, { color: '#0A55A6' }]}>฿30,000</Text>
        </View>
        <View style={{ width: '100%',  backgroundColor: '#FFFFFF', flexDirection: 'row', justifyContent: 'space-between', padding: 10, marginTop: 5, }}>
          <View style={{ width: 200, padding: 5, }}>
            <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4]}>ชำระเงินโดยการโอนเงินผ่านธนาคาร 29-11-2019 </Text>
          </View>
          <TouchableOpacity>
        ...
        <View style={{ width: '100%',  backgroundColor: '#FFFFFF', flexDirection: 'row', justifyContent: 'space-between', padding: 10, marginTop: 5, }}>
          <View style={{flexDirection:'row',}}>
            ...
            <Text style={[stylesFont.FontFamilyText,stylesFont.FontSize3,{marginTop:5,}]}>Status and tracking no</Text>
          </View>
