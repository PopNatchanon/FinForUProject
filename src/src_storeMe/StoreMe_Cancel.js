  ...
  render() {
    return (
      <SafeAreaView style={styleMain.SafeAreaView}>
        ...
        <ScrollView>
          <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize2, { marginLeft: 5, marginTop:5, }]}>รายการที่ยกเลิกสินค้า </Text>
          <Cancel_Product />
          <Cancel_Product />
          <Cancel_Product />
          <Cancel_Product />
        ...
        <View style={styleMain.FrameBackground}>
          <View style={{ height: 50, width: '100%', flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 10, borderColor: '#EAEAEA', borderBottomWidth:1, }}>
            <View style={styleMain.FlexRow}>
              ...
              <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize4, { margin: 10, }]}>PPoo</Text>
            </View>
            <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize4, { margin: 10, color: '#0A55A6' }]}>ถูกยกเลิก</Text>
          </View>
          ...
          <View style={{ height: 50, borderColor: '#EAEAEA', borderTopWidth:1, alignItems: 'flex-end', justifyContent: 'center', padding: 10, }}>
            <TouchableOpacity>
              <View style={{ height: 40, width: 100, backgroundColor: '#0A55A6', justifyContent: 'center', alignItems: 'center', borderRadius: 5, }}>
                <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4, { color: '#FFFFFF' }]}>ติดต่อผู้ซื้อ</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
