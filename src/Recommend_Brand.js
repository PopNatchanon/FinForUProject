            ...
            <View style={stylesMain.FrameBackground}>
                ...
                <View style={stylesTopic.Recommend_Brand_Product}>
                    <View style={stylesTopic.Recommend_Brand_Product_Box}>
                        ...
                        <View>
                            <Text style={[stylesFont.FontSize5, stylesFont.FontFamilyText]}>ห้องพัก Deluxe Pool Villa</Text>
                            <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize5, { color: '#0A55A6', }]}>฿10,000</Text>
                            <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize5, { color: '#C4C4C4', }]}>฿20,000</Text>
                        </View>
                    </View>
                    <View style={stylesTopic.Recommend_Brand_Product_Box}>
                        <View style={stylesTopic.Recommend_Brand_Product_Image}></View>
