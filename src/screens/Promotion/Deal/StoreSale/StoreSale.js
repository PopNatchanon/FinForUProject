...
export default connect(mapStateToProps, mapDispatchToProps)(StoreSale);
function StoreSale(props) {
    ...
    const getUpdateIndex = (v) => {
        var id_category = dataService2.category[v - 1] == undefined ? '' : dataService2.category[v - 1].id_type;
