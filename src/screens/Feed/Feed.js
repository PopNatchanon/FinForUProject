...
///----------------------------------------------------------------------------------------------->>>> Inside/Tools
import { Botton_PopUp_FIN, ExitAppModule, } from '../Main/Main';
...
const {
  BackgroundAreaView, FlexRow, FrameBackground, FrameBackgroundTextStart, ItemCenter, SafeAreaViewNB,
} = stylesMain;
    ...
    return <TouchableOpacity key={i}>
      <View style={{ borderColor: '#C4C4C4', borderWidth: 1.5, marginRight: 5, width: 150, }}>
        <View style={{ height: 60 }}>
          <FastImage resizeMode={cover} source={Image1} style={FullLayout} />
        </View>
        <View style={{ alignItems: 'center' }}>
    ...
    <View style={{ backgroundColor: '#FFFFFF', flex: 1, padding: 10, }}>
      ...
      <View style={[FlexRow, { backgroundColor: '#E0EFFF', borderRadius: 5, marginTop: 10, padding: 10, }]}>
        <View style={{ height: 100, width: 170, }}>
          <FastImage resizeMode={cover} source={Image2} style={FullLayout} />
        </View>
