  ...
  render() {
    return (
      <SafeAreaView style={styleMain.SafeAreaView}>
        ...
        <ScrollView>
          <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize1, { marginLeft: 5, marginTop:5, }]}>รายการที่ยกเลิกสินค้า </Text>
          <Cancel_Product />
          <Cancel_Product />
          <Cancel_Product />
          <Cancel_Product />
    ...
    return (
      <View>
        <View style={styleMain.FrameBackground}>
          <View style={{ height: 50, width: '100%', flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 10, borderColor: '#EAEAEA', borderWidth: 1, }}>
            <View style={styleMain.FlexRow}>
              <View style={{ height: 40, width: 40, backgroundColor: '#C4C4C4', borderRadius: 20, margin: 5, }}></View>
              <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize3, { margin: 10, }]}>PPoo</Text>
            </View>
            <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize3, { margin: 10, color: '#0A55A6' }]}>ถูกยกเลิก</Text>
          </View>
          ...
          <View style={{ height: 50, borderColor: '#C4C4C4', borderWidth: 1, alignItems: 'flex-end', justifyContent: 'center', padding: 10, }}>
            <TouchableOpacity>
              <View style={{ height: 40, width: 100, backgroundColor: '#0A55A6', justifyContent: 'center', alignItems: 'center', borderRadius: 5, }}>
                <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize3, { color: '#FFFFFF' }]}>ติดต่อผู้ซื้อ</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
