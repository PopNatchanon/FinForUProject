...
export let Register_Affiliate = (props) => <View style={[FrameBackground, ItemCenter]}>
    <View style={[ItemCenter, { marginVertical: 10, width: '95%', }]}>
        ...
        <View style={{ borderColor: mainColor, borderRadius: 5, borderWidth: 2, padding: 10, }}>
            <Text style={[FontFamilyBold, FontSize7]}>FIN Affiliate Influencer Program ช่องทางใหม่หารายได้ผ่านโซเชียล</Text>
        ...
        <View style={[ItemCenter, { marginTop: 10 }]}>
            ...
            <TouchableOpacity onPress={() => NavigationNavigate({ ...props, goScreen: 'Business_Froms', })} style={[ItemCenter,
                { borderColor: mainColor, borderRadius: 5, borderWidth: 2, margin: 10, padding: 10, }]}>
