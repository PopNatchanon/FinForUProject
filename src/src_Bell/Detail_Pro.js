        ...
        return (
            <View>
                <View style={stylesMain.FrameBackground}>
                    <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize3]}> ยกเลิกแล้ว </Text>
                ...
                <View style={stylesMain.FrameBackground}>
                    <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize3]}> ที่อยู่ในการจัดส่ง </Text>
                ...
                <View style={stylesMain.FrameBackground}>
                    <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize3]}> สรุปยอดรวมทั้งสิ้น </Text>
                    <View style={[stylesMain.FlexRow, { padding: 10, justifyContent: 'space-between' }]}>
                        <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4]}>ยอดรวม</Text>
                        <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4, { color: '#0A55A6' }]}>฿5,000.00</Text>
                    </View>
                    <View style={[stylesMain.FlexRow, { padding: 10, justifyContent: 'space-between', marginTop: 5, borderTopColor: '#EAEAEA', borderTopWidth: 1, }]}>
                        <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize3]}>ยอดรวมทั้งสิ้น</Text>
                        <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize3, { color: '#0A55A6' }]}>฿5,000.00</Text>
                    </View>
                </View>
            </View>
        );
        ...
        return (
            <View style={stylesMain.FrameBackground}>
                <View style={[stylesMain.FlexRow, { justifyContent: 'space-between', padding: 10, borderColor: '#ECECEC', borderWidth: 1, }]}>
                    <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize3]}> PPooy </Text>
                </View>
                <View style={{ borderColor: '#ECECEC', borderWidth: 1, padding: 10, marginTop: 5, flexDirection: 'row', justifyContent: 'space-between' }}>
                    <View style={{ height: 100, width: 100, flexDirection: 'row' }}>
                        ...
                        />
                        <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4]}>นาฬิกา TISSOT</Text>
                    </View>
                    <View style={{ justifyContent: 'flex-end' }}>
                        <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4]}>x 3</Text>
                        <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4]}>฿10,000</Text>
                    </View>
                </View>
        ...
        return (
            <View style={stylesMain.FrameBackground}>
                <View style={[stylesMain.FlexRow, { padding: 10, justifyContent: 'space-between', borderColor: '#ECECEC', borderWidth: 1 }]}>
                    <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4]}> ยกเลิกโดย </Text>
                    <Text style={[stylesFont.FontFamilyBold, stylesFont.FontSize4]}>FIN</Text>
                </View>
                <View style={[stylesMain.FlexRow, { padding: 10, justifyContent: 'space-between', borderColor: '#ECECEC', borderWidth: 1 }]}>
                    <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4]}>วัน/เวลาที่ยกเลิก</Text>
                    <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4]}>19-2-2020/23.00 น.</Text>
                </View>
                <View style={{ padding: 10, justifyContent: 'space-between', borderColor: '#ECECEC', borderWidth: 1 }}>
                    <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4]}>เหตุผลการยกเลิก</Text>
                    <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize4, { marginLeft: 20, }]}>ไม่มีการชำระเงิน</Text>
                </View>
            </View>
        );
    }
        ...
        return (
            <TouchableOpacity activeOpacity={1} onPress={() => this.props.navigation.navigate('Detail_Pro', { selectedIndex: 2 })}>
                <View style={{ width: '100%', backgroundColor: '#0A55A6', height: 50, alignItems: 'center', justifyContent: 'center', marginTop: 10 }}>
                    <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize3, { color: '#FFFFFF' }]}>ตรวจสอบรายละเอียด</Text>
                </View>
            </TouchableOpacity>
