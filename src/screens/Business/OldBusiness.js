...
function Business(props) {
  ...
  let PathList = () => {
    switch (selectedIndex) {
      case 0: // หน้าเข้ามาครั้งแรก Affiliate มีปุ่มให้กดสมัครสมาชิก // Business_Register
        return <>
          <AppBar {...props} backArrow titleHead='สมาชิกAffiliate' />
          <Register_Affiliate {...props} />
        </>;
      case 1: // หน้าเมนูหลักของ Affiliate // Business
        return <>
          <AppBar {...props} backArrow titleHead='สมาชิกAffiliate' />
          <Menu_Affiliate {...props} />
        </>;
      case 2: //  หน้าโปรไฟล์ของ Affiliate มีเมนูด้านล่าง // Business_Profile
        return <>
          <AppBar {...props} backArrow titleHead='สมาชิกAffiliate' />
          <ScrollView>
      ...
      case 3: //  เข้าจากโปรไฟล์ของ Affiliate รายการสินค้า // Business_Product
        return <>
          <AppBar {...props} backArrow titleHead='สมาชิกAffiliate' />
          <ScrollView>
            <Income {...props} />
      ...
      case 4: //  เข้าจากโปรไฟล์ของ Affiliate การเติบโต // Business_Growth
        return <>
          <AppBar {...props} backArrow titleHead='สมาชิกAffiliate' />
          <Growth />
        </>;
      case 5: //  เข้าจากเมนูหลักของ Affiliate การเงิน // Business_Finance
        return <>
          <AppBar {...props} backArrow titleHead='การเงิน' />
          <Finance {...props} />
        </>;
      case 6: // หน้าแบบFromการสมัครสมาชิก Affiliate // Business_Froms
        return <>
          <AppBar {...props} backArrow titleHead='สมาชิกAffiliate' />
          <Register_Affiliate_From {...props} />
        </>;
      case 7: // หน้าเพิ่มสำเนาบัตรประชาชน เข้าจาก หน้าแบบFromการสมัครสมาชิก Affiliate // Business_IdCard
        return <>
