...
export default connect(mapStateToProps, mapDispatchToProps)(Post_Feed);
            ...
            <View style={[stylesMain.BoxProduct2,]}>
                <View style={[stylesMain.BoxProduct2BoxProduct]}>
                    {dataService && <ProductBox {...props} dataService={dataService.product} mode='row3colall'
                        getDataService={(value) => getDataService(value)} noNavigation pointerUrl='DetailScreen' pointerid_store
