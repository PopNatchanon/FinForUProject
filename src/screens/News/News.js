...
export let NewsBox = (props) => {
    ...
    let BlogItem = (
        item_Blog.map((value, index) => {
            return <TouchableOpacity activeOpacity={1} onPress={() => NavigationNavigate({ goScreen: 'Bell_Detail_Promotion', navigation })} key={index}
