...
export let Headbar = (props) => {
    ...
    var uri;
    dataSevice && dataSevice.list_profile && (uri = `${finip}/${dataSevice.list_profile[0].image_path}/${dataSevice.list_profile[0].image}`);
    return (<View>
        <TouchableOpacity activeOpacity={1} onPress={() => NavigationNavigateScreen({ goScreen: 'Setting_Topic', setData: { selectedIndex: 0, getDataSource: value => getDataSource(value) }, navigation })}>
        ...
        <View style={stylesProfile.HeadbarA}>
            <View style={stylesProfile.HeadbarBox1}>
                <View style={stylesMain.FlexRow}>
                    <View>
                        <TouchableOpacity activeOpacity={1} onPress={() => NavigationNavigateScreen({ goScreen: 'SellerScreen', navigation })}>
                            <View style={stylesProfile.HeadbarBox1Sub}>
                                <Text style={[stylesProfile.HeadbarBox1SubText, stylesFont.FontFamilyText, stylesFont.FontSize6]}>เริ่มค้าขาย</Text>
                            </View>
                        </TouchableOpacity>
                    ...
                    <View style={{ marginLeft: 15, marginTop: '21%' }}>
                        <Text style={[stylesFont.FontSize6, stylesFont.FontFamilyBold, { color: '#FFFFFF' }]}>{dataSevice && dataSevice.list_profile ? dataSevice.list_profile[0].name : ' '}</Text>
                        <Text style={[stylesFont.FontSize7, stylesFont.FontFamilyText, { color: statusOnline ? '#BEBDBD' : '#43e855', }]}><View style={{ height: 8, width: 8, borderRadius: 4, backgroundColor: '#43e855' }}></View>Active อยู่</Text>
                        <Text style={[stylesFont.FontSize7, stylesFont.FontFamilyText, { color: '#FFFFFF' }]}>ผู้ติดตาม {dataSevice && dataSevice.who_follow_me ? dataSevice.who_follow_me : 0} | กำลังติดตาม {dataSevice && dataSevice.my_follow ? dataSevice.my_follow : 0}</Text>
                    </View>
                </View>
...
export let Menubar = (props) => {
    ...
    return (<View style={stylesProfile.Menu}>
        <View style={[stylesMain.ItemCenter, stylesProfile.Menubar]}>
            ...
            <TouchableOpacity activeOpacity={0.9} onPress={() => NavigationNavigateScreen({ goScreen: 'Total_Order', setData: { selectedIndex: 0 }, navigation })} style={{ flexDirection: 'row' }}>
...
export let MenubarSub = (props) => {
    ...
    return (<View style={stylesProfile.MenubarSub}>
        <View style={stylesMain.FlexRow}>
            <TouchableOpacity activeOpacity={0.9} onPress={() => NavigationNavigateScreen({ goScreen: 'Total_Order', setData: { selectedIndex: 1 }, navigation })}>
            ...
            <TouchableOpacity activeOpacity={0.9} onPress={() => NavigationNavigateScreen({ goScreen: 'Total_Order', setData: { selectedIndex: 2 }, navigation })}>
                <View style={[stylesMain.ItemCenter, { width: width * (1 / 4) }]}>
            ...
            <TouchableOpacity activeOpacity={0.9} onPress={() => NavigationNavigateScreen({ goScreen: 'Total_Order', setData: { selectedIndex: 3 }, navigation })}>
                <View style={[stylesMain.ItemCenter, { width: width * (1 / 4) }]}>
        ...
        <View style={[stylesProfile.MenubarSubLine2, stylesMain.FlexRow]}>
            <TouchableOpacity onPress={() => NavigationNavigateScreen({ goScreen: 'Return_products', setData: { selectedIndex: 0 }, navigation })}>
                <View style={[stylesProfile.MenubarSubLine2Box, stylesMain.ItemCenter, stylesMain.FlexRow]}>
                    ...
                    <Text style={[stylesProfile.MenubarSubLine2BoxName, stylesFont.FontFamilyText, stylesFont.FontSize6]}>คืนสินค้า/คืนเงิน</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => NavigationNavigateScreen({ goScreen: 'CancelScreen', setData: { selectedIndex: 0 }, navigation })}>
                <View style={[stylesProfile.MenubarSubLine2Box, stylesMain.ItemCenter, stylesMain.FlexRow]}>
                    <FastImage source={require('../../icon/box.png')} style={stylesProfile.MenubarSubLine2BoxImage} />
                    <Text style={[stylesProfile.MenubarSubLine2BoxName, stylesFont.FontFamilyText, stylesFont.FontSize6]}>ยกเลิกสินค้า</Text>
                </View>
            </TouchableOpacity>
        </View>
    </View>);
        ...
        <View style={[stylesProfile.ListbarMain, stylesMain.FlexRow]}>
            <TouchableOpacity activeOpacity={0.9} onPress={() => setPathlist(0)}>
                <View style={[stylesMain.FlexColumn, stylesMain.ItemCenter, { width: width * (1 / 4) }]}>
                    ...
                    <Text style={[stylesProfile.ListbarBoxText, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>หน้าหลัก</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.9} onPress={() => NavigationNavigateScreen({ goScreen: 'DealScreen', navigation })}>
                <View style={[stylesMain.FlexColumn, stylesMain.ItemCenter, { width: width * (1 / 4) }]}>
                    ...
                    <Text style={[stylesProfile.ListbarBoxText, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>โปรโมชัน</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.9} onPress={() => setPathlist(2)}>
                <View style={[stylesMain.FlexColumn, stylesMain.ItemCenter, { width: width * (1 / 4) }]}>
                    ...
                    <Text style={[stylesProfile.ListbarBoxText, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>โค้ดส่วนลด</Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={0.9} onPress={() => NavigationNavigateScreen({ goScreen: 'CoinScreen', navigation })}>
                <View style={[stylesMain.FlexColumn, stylesMain.ItemCenter, { width: width * (1 / 4) }]}>
                    ...
                    <Text style={[stylesProfile.ListbarBoxText, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>Fin coin ของฉัน</Text>
                </View>
            </TouchableOpacity>
        </View>
        <View>
...
export let ListMenu = (props) => {
    ...
    return (<View>
        <View style={stylesProfile.ListMenu}>
            <TouchableOpacity activeOpacity={1} onPress={() => NavigationNavigateScreen({ goScreen: 'Profile_Topic', setData: { selectedIndex: 0 }, navigation })}>
                <View style={stylesProfile.ListMenuList}>
                    <View style={stylesProfile.ListMenuListSub}>
                        ...
                        <Text style={[stylesProfile.ListMenuListSubName, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>ดูล่าสุด</Text>
                    </View>
                    <IconEntypo name='chevron-right' style={stylesProfile.ListMenuListIcon} size={35} color={mainColor} />
                </View>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={1} onPress={() => NavigationNavigateScreen({ goScreen: 'Business', setData: { selectedIndex: 0 }, navigation })}>
                <View style={stylesProfile.ListMenuList}>
                    <View style={stylesProfile.ListMenuListSub}>
                        <IconFontAwesome RightItem name="users" size={30} color='#7CB4F0' style={stylesProfile.ListMenuListSubIcon} />
                        <Text style={[stylesProfile.ListMenuListSubName, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>สมาชิกAffiliate</Text>
                    </View>
                    <IconEntypo name='chevron-right' style={stylesProfile.ListMenuListIcon} size={35} color={mainColor} />
                </View>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={1} onPress={() => NavigationNavigateScreen({ goScreen: 'Profile_Topic', setData: { selectedIndex: 1 }, navigation })}>
                <View style={stylesProfile.ListMenuList}>
                    <View style={stylesProfile.ListMenuListSub}>
                        <IconAntDesign RightItem name="wechat" size={35} color={mainColor} style={stylesProfile.ListMenuListSubIcon} />
                        <Text style={[stylesProfile.ListMenuListSubName, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>แชท</Text>
                    </View>
                    <IconEntypo name='chevron-right' style={stylesProfile.ListMenuListIcon} size={35} color={mainColor} />
                </View>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={1} onPress={() => NavigationNavigateScreen({ goScreen: 'Profile_Topic', setData: { selectedIndex: 2 }, navigation })}>
                <View style={stylesProfile.ListMenuList}>
                    <View style={stylesProfile.ListMenuListSub}>
                        <IconAntDesign RightItem name="heart" size={35} color='#D74024' style={stylesProfile.ListMenuListSubIcon} />
                        <Text style={[stylesProfile.ListMenuListSubName, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>สิ่งที่สนใจ</Text>
                    </View>
                    <IconEntypo name='chevron-right' style={stylesProfile.ListMenuListIcon} size={35} color={mainColor} />
                </View>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={1} onPress={() => NavigationNavigateScreen({ goScreen: 'Profile_Topic', setData: { selectedIndex: 3 }, navigation })}>
                <View style={stylesProfile.ListMenuList}>
                    <View style={stylesProfile.ListMenuListSub}>
                        <IconFontisto RightItem name="shopping-store" size={30} color={mainColor} style={stylesProfile.ListMenuListSubIcon} />
                        <Text style={[stylesProfile.ListMenuListSubName, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>ร้านค้าที่ติดตาม</Text>
                    </View>
                    <IconEntypo name='chevron-right' style={stylesProfile.ListMenuListIcon} size={35} color={mainColor} />
                </View>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={1} onPress={() => NavigationNavigateScreen({ goScreen: 'Profile_Topic', setData: { selectedIndex: 4 }, navigation })}>
                <View style={stylesProfile.ListMenuList}>
                    <View style={stylesProfile.ListMenuListSub}>
                        <IconMaterialCommunityIcons RightItem name="star-box" size={35} color='#EAD295' style={stylesProfile.ListMenuListSubIcon} />
                        <Text style={[stylesProfile.ListMenuListSubName, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>รีวิวของฉัน</Text>
                    </View>
                    <IconEntypo name='chevron-right' style={stylesProfile.ListMenuListIcon} size={35} color={mainColor} />
                </View>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={1} onPress={() => NavigationNavigateScreen({ goScreen: 'Profile_Topic', setData: { selectedIndex: 5 }, navigation })}>
                <View style={stylesProfile.ListMenuList}>
                    <View style={stylesProfile.ListMenuListSub}>
                        <IconFeather RightItem name="help-circle" size={35} color='#00A3FF' style={stylesProfile.ListMenuListSubIcon} />
                        <Text style={[stylesProfile.ListMenuListSubName, stylesFont.FontFamilyText, stylesFont.FontSize6, stylesFont.FontCenter]}>ช่วยเหลือ</Text>
                    </View>
                    <IconEntypo name='chevron-right' style={stylesProfile.ListMenuListIcon} size={35} color={mainColor} />
                </View>
            </TouchableOpacity>
...
export let ViewCode = (props) => {
    ...
    const [dataSevice, setDataSevice] = useState(undefined);
    const [pathlist, setPathlist] = useState(0);
    const item = [{ name: 'โค้ดที่ใช้ได้' }, { name: 'โค้ดที่ใช้ไปแล้ว' }, { name: 'โ่ค้ดที่หมดอายุ' }];
    var dataBody = {
    ...
    useEffect(() => { activeGetServices && GetServices({ uriPointer: pathlist == 0 ? uri : pathlist == 1 ? uri2 : uri3, dataBody, Authorization: cokie, getDataSource: value => getDataSource(value) }); }, [activeGetServices]);
    return (<View>
        ...
        <View>
            <MyCode {...props} key='MyCode' dataSevice={dataSevice} codeList={pathlist == 0 ? 'available' : pathlist == 1 ? 'usedCode' : 'timeOut'} />
        </View>
    </View>);
};
///----------------------------------------------------------------------------------------------->>>> MyCode
export let MyCode = (props) => {
    ...
    let followStore = (value, value2) => {
        setActiveFollow(true);
        setId_store(value);
        setFollow(value2);
    };
    let getData = value => {
        data[data.map((value2) => { return value2.id_store }).indexOf(value.m)].follow = value.output;
        setData(data);
        setActiveFollow(false);
    };
    useEffect(() => { activeFollow && currentUser && cokie && GetServices({ Authorization: cokie, dataBody, uriPointer: uri, getDataSource: value => getData(value), }); }, [activeFollow && currentUser && cokie]);
    if (data[0] == undefined && dataSevice) {
        dataSevice.store.map((value) => {
            return ([(data.every((value2) => { return value2.id_store != value.id_store })) ?
                ([data.push({ id_store: value.id_store, promotion_name: [value.promotion_name], store_name: value.store_name }),]) :
                ([data[data.map((value2) => { return value2.id_store }).indexOf(value.id_store)].promotion_name.push(value.promotion_name),]),]);
        });
        setData(data);
    };
            ...
            <View style={stylesMain.ItemCenter}>
                    ...
                    {data && data.map((value, index) => {
                        return <View key={index} style={[stylesMain.FlexRow, stylesProfile.FinMinssionBoxPlan1]}>
                            ...
                            <View style={{ marginLeft: 16 }}>
                                <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize6, { marginTop: 5 }]}>ติดตามร้าน {value.store_name}</Text>
                                <View style={{ flexDirection: 'row' }}>
                                    {[value.promotion_name.map((value2, index2) => {
                                        return (index2 < 3 && (<View key={index2} style={[stylesProfile.FinMinssionBoxPlan1Code, stylesMain.ItemCenter]}>
                                            <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize7, { color: 'white' }]}>{value2}</Text>
                                        </View>))
                                    }),
                                    value.promotion_name.length > 3 &&
                                    <View key={'otherpromotion_name'} style={[stylesProfile.FinMinssionBoxPlan1Code, stylesMain.ItemCenter, { width: 30 }]}>
                                        <Text style={[stylesFont.FontFamilyText, stylesFont.FontSize7, { color: 'white' }]}>+{value.promotion_name.length - 3}</Text>
                                    </View>]}
                                </View>
                            </View>
                            <View style={stylesProfile.FinMinssionBoxPlan1Follow}>
                                <TouchableOpacity onPress={() => followStore(value.id_store, true)}>
                                    <View style={[stylesProfile.FinMinssionBoxPlan1FollowBox, stylesMain.ItemCenter,]}>
                                        <Text style={[stylesMain.ItemCenterVertical, stylesFont.FontFamilyText, stylesFont.FontSize6]}>{value.follow}</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                        </View>
                ...
                <View style={[stylesMain.BoxProduct2BoxProduct, { backgroundColor: '#fff', paddingTop: 2 }]}>
                    {dataSevice && dataSevice.coupon.map((value, index) => {
                        return <GetCoupon key={index} flexRow useCoupon codeList={codeList} colorCoupon='#007bff' timeOut={value.date_end}
                            couponText={value.name_promotion} textDetail={value.detail_promotion} />
                    })}
                </View>
            </View>
        </View> :
